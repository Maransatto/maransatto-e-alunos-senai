...
describe("Teste de validação valor_do_jogo ", function() {
  ...
  it("Valores Sorteio do Placar ", function() {
	...
	expect( sorteio() ).not.toEqual(-1);
	
	expect( sorteio() ).not.toEqual(5);
	
	expect( sorteio() ).not.toEqual(6);
...
describe("Teste de validação validar_pontos ", function() {
  ...
  it("Validar Campeões ", function() {
	...
	expect( validar_pontos(1,3) ).toEqual("Vitória do Time 2");

	expect( validar_pontos(3,1) ).toEqual("Vitória do Time 1");
